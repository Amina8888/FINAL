...
const Navbar: React.FC = () => {
  ...
  const getNavLinks = () => {
    switch (userRole) {
      ...
      case 'consultant':
        return ['Dashboard', 'My Clients', 'Schedule', 'Messages'];
      default:
          ...
          <div className="hidden md:block">
            {isAuthenticated ? (
              <div className="relative group">
                ...
                <div className="absolute right-0 w-48 py-2 mt-2 bg-white rounded-md shadow-xl hidden group-hover:block z-50">
                  ...
                  {userRole === 'consultant' && (
                    <Link to="/documents" className="block px-4 py-2 text-gray-800 hover:bg-gray-100">
                      <FileText className="inline-block w-4 h-4 mr-2" /> Documents
                    </Link>
                  )}
