...
import { PasswordIsCorrect } from "../../components/PasswordIsCorrect";
import { TextInputConfirm } from "../../components/TextInputConfirm";
import { TextInputEmail } from "../../components/TextInputEmail";

export const ModalRegisterPage = (): JSX.Element => {
  return (
    <div
      className="flex h-[1024px] items-center gap-2.5 px-[513px] py-[280px] relative bg-[#007aff45] w-full min-w-[1440px]"
      data-model-id="12:296"
    >
