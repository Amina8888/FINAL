...
export default function EditProfile() {
  ...
  useEffect(() => {
    fetch("https://localhost:5085/api/specialist/profile", {
  ...
  const handleSubmit = async (e) => {
    ...
    await fetch("https://localhost:5085/api/specialist/update-profile", {
      method: "PUT",
      headers: {
    ...
    if (license) {
      ...
      await fetch("https://localhost:5085/api/specialist/upload-license", {
        method: "POST",
        headers: {
          Authorization: `Bearer ${token}`,
        },
